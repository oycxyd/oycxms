...
class preprocess(Frame):
    ...
    def diagnose_match (self):
        if self.start_switch1.get() == 1:
            ...
            if self.start_switch2.get() == 1:
                ...
                #         sys.argv = ["shift_diagnostics.py", "--ref-mz-pos", 
                #                     self.custom_masses, input_path]
                #     if self.refs_entry1.get()=='neg':
                #         sys.argv = ["shift_diagnostics.py", "--ref-mz-neg", 
                #                     self.custom_masses, '', input_path]
                exec(diagnose)
                param1 = TOL[sel_ind]
                # param1 = 10
    ...
    def set_refs(self):
        ...
        # dum = [float(i) for i in lst]
        self.custom_masses = lst
        self.custom_masses = ', '.join(self.custom_masses)             
